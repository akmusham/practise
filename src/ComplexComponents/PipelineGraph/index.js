...
import { getGroupForResult, decodeResultValue } from './Components/StatusIndicator';
import { strokeWidth as nodeStrokeWidth } from './Components/SvgSpinner';
...
export class PipelineGraph extends Component {
     ...
     * Adds all the SVG components to the elements list.
     */
    renderSkippingConnections(sourceNodes,
                              destinationNodes,
                              skippedNodes,
                              elements) {
     ...
     * Adds all the SVG components to the elements list.
     */
    renderBasicCurvedConnection(leftNode, rightNode, midPointX, elements) {
